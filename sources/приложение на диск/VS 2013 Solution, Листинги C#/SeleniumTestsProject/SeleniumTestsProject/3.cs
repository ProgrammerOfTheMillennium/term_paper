...
{
    [TestFixture]
    public class III_Проверка_прихода_письма
    {
        ...
        [Test]
        public void The_III_Проверка_прихода_письма_Test()
        {
            ...
            Thread.Sleep(4000);
            //selenium.SendKeys("xpath=(//input[@class=\"b-yabble__input js-add-contact js-kbd-compose-input\"])", "at11.at11@yandex.ru");
